...
const SkillProgress = () => {
  ...
  const skills = [
    ...
    { name: "C", level: 80, color: "bg-cyan-500" },
    { name: "Bootstrap", level: 85, color: "bg-indigo-500" },
    { name: "Node.js", level: 85, color: "bg-green-600" },
    { name: "Express.js", level: 82, color: "bg-gray-500" },
    ...
    { name: "Wireframing", level: 85, color: "bg-pink-600" },
    { name: "Flutter", level: 60, color: "bg-cyan-400", isProjectBased: true },
              ...
              >
                <div className="flex justify-between mb-2">
                  ...
                  <span className="text-primary font-semibold">
                    {skill.isProjectBased ? "Project-based Experience" : `${skill.level}%`}
                  </span>
                </div>
                <Progress 
