  ...
  const skillCategories = [
    {
      ...
      skills: ["C", "JavaScript", "PHP", "Dart", "Flutter"],
      featured: false
    },
    {
      icon: <Code className="w-8 h-8" />,
      title: "Web Technologies",
      skills: ["HTML", "CSS", "React.js", "Bootstrap", "Node.js", "Express.js", "SQL", "MySQL", "MongoDB", "PostgreSQL", "JWT", "REST API"],
      featured: false
    },
    {
      icon: <GitBranch className="w-8 h-8" />,
      title: "Design & Tools",
      skills: ["Figma (UI/UX)", "Prototyping", "Wireframing", "Git", "GitHub", "VS Code", "Postman"],
      featured: false
    },
    {
